...
É importante lembrar que se a `version` do [pyproject.toml](gces-bib/pyproject.toml) for igual a uma versão da biblioteca que já foi publicada, um erro poderá acontecer no workflow.
